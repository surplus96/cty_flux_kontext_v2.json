# cty_flux_kontext_v2.json

Dockerized ComfyUI workflow: CTY_FLUX_KONTEXT_V2.json
...
docker build -t cty_flux_kontext_v2.json .

# Run the container
docker run -p 8188:8188 cty_flux_kontext_v2.json
```
